...
int32_t BSP_I2C1_Send(uint16_t Addr, uint16_t Reg, uint8_t *pData, uint16_t Length);
int32_t BSP_I2C1_Recv(uint16_t Addr, uint16_t Reg, uint8_t *pData, uint16_t Length);
...
int32_t BSP_I2C1_SendRecvSimplex(uint16_t DevAddr, uint8_t *pTxdata, uint8_t *pRxdata, uint16_t Length);
#if (USE_HAL_I2C_REGISTER_CALLBACKS == 1)
...
int32_t BSP_SPI1_Recv(uint8_t DevAddr, uint8_t Reg, uint8_t *pData, uint16_t Length);
