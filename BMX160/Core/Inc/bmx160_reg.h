...
#ifndef INC_BMX160_DEFS_H_
#define INC_BMX160_DEFS_H_
...
/** PMU status Macros */
#define BMI160_AUX_PMU_SUSPEND               UINT8_C(0x00)	//Acceleration status
...
#define BMI160_AUX_DATA_ADDR                 UINT8_C(0x04) // mag and rhall data
...
#define BMI160_AUX_IF_0_ADDR                 UINT8_C(0x4C) // this changes
#define BMI160_AUX_IF_1_ADDR                 UINT8_C(0x4D)
#define BMI160_AUX_IF_2_ADDR                 UINT8_C(0x4E)
#define BMI160_AUX_IF_3_ADDR                 UINT8_C(0x4F)
...
/*** Added by Karen to follow the BSP architecture ***/
typedef int32_t (*bmx160_write_ptr)(void *, uint8_t, uint8_t*, uint16_t); //Ctx, reg_address, data, length
typedef int32_t (*bmx160_read_ptr) (void *, uint8_t, uint8_t*, uint16_t); // same
typedef void	(*bmx160_delay_ptr)(void *, uint32_t); //Ctx. period
...
typedef struct {
	...
	bmx160_write_ptr write_reg;
	bmx160_read_ptr	 read_reg;
	bmx160_delay_ptr delay;
